...
//    public static ItemStack getItemStack(Config config) {
//        Material material = Material.valueOf( config.getString("item.material"));
//        String name = config.getColoredString("item.name");
//        List<String> lore = Utils.coloraLista(config.getStringList("item.lore"));
//        ItemStack item = new ItemStack(material);
//        ItemMeta meta = item.getItemMeta();
//        meta.setLore(lore);
//        meta.setDisplayName(name);
//        item.setItemMeta(meta);
//        return NBTEditor.addNBT(item, "item", material.name());
//    }
...
//    public static FancyPair<ItemStack, Integer> getPairFromConfigSection(ConfigurationSection section) {
//        ItemStack stack = getFromConfiguration(section);
//        int slot = section.getInt("slot");
//        return new FancyPair<>(stack, slot);
//    }
